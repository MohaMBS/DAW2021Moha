...
if ($_SERVER["REQUEST_METHOD"]== "POST"){ 
    ...
    if (isset($_REQUEST["emailR"])){
        if (exsiste($_REQUEST["emailR"])){
            ...
            $mail->Body = '<html><body>Hola,'.$_REQUEST['emailR'].'</br> para poder recuperar la contraseña debes hacer click <a href="https://dawjavi.insjoaquimmir.cat/mboughima/Clase/M07/UF1/a6/recuperacionpass.php">aquí</a>, tienes 12 horas para poder recuperar la contraseña.</body></html>';
